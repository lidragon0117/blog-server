...
export function getAllCategoriesApi() {
    return request({
        url: '/client/article/categorie-all',
        method: 'get'
    })
}
...
export function getCarouselArticlesApi() {
    return request({
        url: '/client/article/getCarousels',
        method: 'get',
    })
}
...
export function getRecommendArticlesApi() {
    return request({
        url: '/client/article/getRecommends',
        method: 'get',
    })
}
