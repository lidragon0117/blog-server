...
import com.lilong.system.mapper.SysMenuMapper;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
    ...
    public List<RouterVO> getCurrentUserMenu() {
        ...
        if (CurrentUserHelper.hasRole(Constants.ADMIN)) {
            ...
            menus = baseMapper.getMenusByUserId(CurrentUserHelper.getUserId().intValue(), MenuTypeEnum.BUTTON.getCode());
        }
    ...
    @Override
    public List<String> selectPermissionList(QueryPermissionRequest permissionRequest) {
        return baseMapper.getPermissionListByUserId(permissionRequest.getUserId(), permissionRequest.getType());
    }
