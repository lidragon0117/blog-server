...
public class RedisUtil {
    ...
    public boolean zAdd(String key, String value, long score, long liveTime) {
        ...
        if (liveTime > 0) {
            expire(key, liveTime,TimeUnit.SECONDS);
        }
        return true;
    }
    ...
    public Long convertAndSend(String channel, String messageValue) {
        return redisTemplate.convertAndSend(channel, messageValue);
    }
}
